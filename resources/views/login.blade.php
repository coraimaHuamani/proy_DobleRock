    ...
    <div class="w-full max-w-md bg-[#181818] border border-[#232323] rounded-lg shadow-lg p-8">
        ...
        <form method="POST" action="#">
            ...
            <div class="mb-4">
                ...
                <input id="email" name="email" type="email" required autofocus class="w-full px-4 py-2 rounded bg-[#232323] border border-[#222] text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#e7452e]">
            </div>
            <div class="mb-6">
