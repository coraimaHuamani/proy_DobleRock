{{-- filepath: d:\Tecnovedades\proy_DobleRock\resources\views\categorias\_agregar.blade.php --}}
<div id="categorias-create-section"
    class="flex-col hidden w-full max-w-[770px] p-6 sm:p-8 bg-[#181818] rounded-lg shadow text-white gap-7">
    <h3 class="text-left font-bold">Crear una categoría</h3>
    <form id="create-categorias-form" data-id="" class="flex flex-col">

        <label for="create-categoria-nombre" class="block text-gray-300 text-sm font-bold mb-2 mt-4">Nombre</label>
        <input id="create-categoria-nombre" type="text" name="nombre" required
        ...
        <label for="create-categoria-descripcion"
            class="block text-gray-300 text-sm font-bold mb-2 mt-4">Descripción</label>
        <textarea id="create-categoria-descripcion" name="descripcion" rows="3"
