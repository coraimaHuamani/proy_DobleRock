<div id="news-edit-section" class="flex-col hidden w-full max-w-[770px] p-6 sm:p-8 bg-[#181818] rounded-lg shadow text-white gap-7">
  <h3 class=" text-left font-bold ">Editar Noticia</h3>
    <form id="edit-news-form" data-id="" class="flex flex-col ">
      ...
      <input id="edit-new-description" type="text" name="description" class="w-full px-4 py-2 rounded-md bg-[#232323] border-[1px] border-gray-500 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#e7452e]">

      <label for="edit-new-category" class="block text-gray-300 text-sm font-bold mb-2 mt-4">Categoria</label>
      <input id="edit-new-category" type="text" name="category" class="w-full px-4 py-2 rounded-md bg-[#232323] border-[1px] border-gray-500 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#e7452e]">
