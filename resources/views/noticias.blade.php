...
<section class="shop-wrap relative text-white min-h-screen pb-16 bg-cover bg-center" style="background-image: url('https://images.pexels.com/photos/15474721/pexels-photo-15474721.jpeg?_gl=1*1s948t4*_ga*MTgxOTg3ODAzNS4xNzU3NzQ0MzM3*_ga_8JE65Q40S6*czE3NTc3NDQzMzYkbzEkZzEkdDE3NTc3NDQzNzUkajIxJGwwJGgw'); background-size: cover; background-position: center;">
  ...
  <div class="relative flex flex-col mx-auto px-6 md:px-12 lg:px-24 ">
    ...
    <header class="py-10 text-center  justify-items-center">
      ...
      <h2 class="mt-5 text-gray-300 w-100% max-w-2xl md:text-lg">Mantente al día con las últimas noticias del mundo del rock, próximos conciertos, lanzamientos de álbumes y eventos exclusivos</h2>
    </header>
    ...
    <button id="more-events-btn" type="button" class="mt-3 py-3 px-5 rounded-3xl bg-[#e7452e] hover:border-white text-[16px] font-bold w-fit self-center"> 
